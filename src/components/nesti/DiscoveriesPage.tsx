...
export function DiscoveriesPage() {
  const activities = [
    ...
    {
      id: 7,
      title: "Atelier poterie parent-enfant",
      category: "Créatif",
      type: "Art",
      image: "🏺",
      location: "L'Atelier Terre, Paris 10e",
      distance: "3,8 km",
      date: "Samedi 11h00",
      price: "45€ le duo",
      rating: 4.9,
      reviews: 89,
      description: "Créez ensemble un objet en argile. Moment créatif et apaisant.",
      tags: ["Art", "Parent-enfant", "Créatif"],
      aiMatch: 93,
    },
    {
      id: 8,
      title: "Piscine à vagues familiale",
      category: "Sport",
      type: "Natation",
      image: "🏊",
      location: "Aquaboulevard, Paris 15e",
      distance: "4,2 km",
      date: "Tous les jours",
      price: "28€ adulte, 18€ enfant",
      rating: 4.4,
      reviews: 567,
      description: "Espace aquatique avec toboggans, vagues et zone enfants.",
      tags: ["Natation", "Famille", "Loisirs"],
      aiMatch: 86,
    },
  ];
  ...
  const articles = [
    ...
    {
      id: 4,
      title: "Comment initier vos enfants à l'art",
      category: "Culture",
      image: "🎨",
      readTime: "6 min",
      summary: "Visites de musées, ateliers créatifs et activités artistiques à la maison.",
    },
    {
      id: 5,
      title: "Organiser des vacances éco-responsables",
      category: "Voyage",
      image: "🌍",
      readTime: "8 min",
      summary: "Conseils pour des vacances en famille respectueuses de l'environnement.",
    },
  ];
